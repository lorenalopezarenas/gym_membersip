...
El proyecto consiste en realizar un EDA y Dashboard analizando unos datos de libre elección, en este caso, son datos contiene quw información sobre el uso de un gimnasio por parte de los miembros y la renovación de sus membresías.
El objetivo es realizar un análisis exploratorio de los datos para sacar conclusiones que sean de interés para la empresa.


Dicho proyecto se ha realizado con Google Sheets y se puede encontrar en el siguiente enlace:
